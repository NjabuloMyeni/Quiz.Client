...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(564, 390);
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Ink Free", 9.75F, static_cast<System::Drawing::FontStyle>((System::Drawing::FontStyle::Bold | System::Drawing::FontStyle::Italic)),
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(48, 390);
			...
			this->label2->Location = System::Drawing::Point(193, 150);
			this->label2->Name = L"label1";
			this->label2->Size = System::Drawing::Size(35, 13);
			this->label2->TabIndex = 2;
			this->label2->Text = codequestion;
			if (this->sessionquestionspointer->at(currentIndex).questionModel.CodeQuestion.empty()) this->label2->Hide();
			// 
			// checkBox1
			// 
			...
			this->ClientSize = System::Drawing::Size(700, 445);
...
#pragma endregion
		private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			if (currentIndex + 1 < sessionquestionspointer->size()) {
				currentIndex++;
				QuestionWork();
				OptionWork();
			}
